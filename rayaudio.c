...
int main(void) {
    ...
    // Previous value, used to test if sine needs to be rewritten, and to smoothly modulate
    frequency float oldFrequency = 1.0f;
    ...
    */
    ...
    while (!WindowShouldClose())  // Detect window close button or ESC key
    {
        ...
        // Compute two cycles to allow the buffer padding, simplifying any modulation, resampling,
        // etc.
        ...
        */
        ...
        DrawText(TextFormat("sine frequency: %i", (int)frequency), GetScreenWidth() - 220, 10, 20,
                 RED);
